...
// ARAppUpdater
#define COCOAPODS_POD_AVAILABLE_ARAppUpdater
#define COCOAPODS_VERSION_MAJOR_ARAppUpdater 0
#define COCOAPODS_VERSION_MINOR_ARAppUpdater 1
#define COCOAPODS_VERSION_PATCH_ARAppUpdater 0
